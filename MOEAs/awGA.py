...
if __name__ == '__main__':
    ...
    dir_path = os.path.join(ROOT_PATH, 'result_change', parent_dir, DATASET_NAME.split('.')[0], 'awGA')
    if not os.path.exists(dir_path):
        os.makedirs(dir_path)
    df1.to_csv(os.path.join(dir_path, f'Variable_awGA_{ML_method}.csv'), header=None, index=None)
    df2.to_csv(os.path.join(dir_path, f'Objective_awGA_{ML_method}.csv'), header=None, index=None)
