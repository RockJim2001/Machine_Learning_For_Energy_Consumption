...
.. module:: LZ09
    :测试函数LZ09系列(F1-F9)
    :Zhang, Qingfu & Liu, W & Li, Hui. (2009). The performance of 
    a new version of MOEA/D on CEC09 unconstrained MOP test instances . 
"""
...
class LZ09(FloatProblem):
    ...
    def __init__(self,
        ...
        * H. Li and Q. Zhang. Multiobjective optimization problems with complicated pareto sets, MOEA/D and NSGA-II.
        ...
        self.obj_directions = [self.MINIMIZE, self.MINIMIZE, self.MINIMIZE]  # -1， -1， -1
        self.obj_labels = ['f(x)', 'f(y)', 'f(z)']
        # FloatProblem 中需要的构造函数
