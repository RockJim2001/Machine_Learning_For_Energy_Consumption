...
class GenerationalDistanceTestCases(unittest.TestCase):
    """ Class including temp tests for class GenerationalDistance
    """
...
class InvertedGenerationalDistanceTestCases(unittest.TestCase):
    """ Class including temp tests for class InvertedGenerationalDistance
    """
...
class EpsilonIndicatorTestCases(unittest.TestCase):
    """ Class including temp tests for class EpsilonIndicator
    """
