...
.. module:: neighborhood
   ...
   给定列表元素的一个索引，根据相应准则找到它的邻域解
.. moduleauthor:: Antonio J. Nebro <antonio@lcc.uma.es>
"""

S = TypeVar('S')

# 给定种群中某一个解的下标索引，找到这个解的邻域
...
class WeightVectorNeighborhood(WeightNeighborhood):
    ...
    def get_neighborhood(self):
        return self.neighborhood  # 种群大小（5） * 邻域个数（3） 的nparray表, 如[[2,4,5],[3,4,5],[4,1,5],[5,1,2],[1,3,4]]
