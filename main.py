...
if __name__ == '__main__':
    ...
    # models = ['GBDTRegressor']
    result = []
    # 数据名称
    # header = 'x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,y1,y2,y3,y4,y5,y6'
    # header = 'x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,y1,y2,y3,y4,y5'
    header = 'x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,zong'
    for name in models:
        print(f"当前的模型是：{name}")
